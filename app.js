...
function updateCheckoutBtn(total) {
  ...
  if (cart.length === 0) {
    checkoutBtn.href = 'https://wa.me/919401928636?text=Hello%20Navkar%20Furniture%2C%20I%20want%20to%20place%20an%20order.';
    return;
  }

  let msg = '\uD83E\uDE91 *New Order \u2013 Navkar Furniture*\n\n';
  msg += '\uD83D\uDCCB *Order Details:*\n';
  cart.forEach((item, i) => {
    const itemTotal = item.price * item.qty;
    msg += (i + 1) + '. ' + item.name + '\n';
    msg += '   Qty: ' + item.qty + '  \xd7  \u20b9' + item.price.toLocaleString('en-IN') + ' = \u20b9' + itemTotal.toLocaleString('en-IN') + '\n';
  });
  msg += '\n\uD83D\uDCB0 *Total Amount: \u20b9' + total.toLocaleString('en-IN') + '*\n\n';
  msg += 'Please confirm availability and delivery details. Thank you! \uD83D\uDE4F';

  checkoutBtn.href = 'https://wa.me/919401928636?text=' + encodeURIComponent(msg);
}
...
// ==============================
// QUICK VIEW – WhatsApp Enquiry
// ==============================
function openModal(productId) {
  const msg = encodeURIComponent('Hello Navkar Furniture, I want to know more about: ' + productId + '. Please share details and pricing.');
